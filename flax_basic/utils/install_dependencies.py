...
python_dependencies = (
    ...
    ('Concurrent Log Handler',
     'http://pypi.python.org/packages/source/C/ConcurrentLogHandler/ConcurrentLogHandler-0.8.3.tar.gz',
     'ConcurrentLogHandler-0.8.3.tar.gz',
     'dae6c9682f8d352df418e4ef27e3131ded60ff1b',
     (),
    ),
    ('CherryPy web application server',
     'http://download.cherrypy.org/cherrypy/3.1.2/CherryPy-3.1.2.tar.gz',
     'CherryPy.tar.gz',
     'a94aedfd0e675858dbcc32dd250c23d285ee9b88',
     (),
    ),
